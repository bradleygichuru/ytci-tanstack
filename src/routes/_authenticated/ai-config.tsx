...
function AiConfigPlaceholder() {
  return (
    <div className="flex flex-col items-center justify-center py-24">
      <Gear className="mb-4 h-16 w-16 text-[var(--on-surface-variant)]" weight="duotone" />
      <h1 className="font-sans text-2xl font-bold tracking-tight text-[var(--on-surface)]">AI Engine Configuration</h1>
      <p className="mt-2 max-w-md text-center text-sm text-[var(--on-surface-variant)]">
